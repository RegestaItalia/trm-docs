...
<div style="display:flex; gap:12px; flex-wrap:wrap">
  <img src="/assets/examples/1_1_publish_and_install.png" alt="Creating a package" style="flex:1 1 300px; max-width:100%; height:auto">
  <img src="/assets/examples/1_2_publish_and_install.png" alt="Creating a class" style="flex:1 1 300px; max-width:100%; height:auto">
</div>

With `trm-server` installed, this is my current workspace:

<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_3_publish_and_install.png" alt="Current workspace viewed in Eclipse" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_4_publish_and_install.png" alt="Adding a method" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_5_publish_and_install.png" alt="Connection to SAP" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_6_publish_and_install.png" alt="Version proposal" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_7_publish_and_install.png" alt="Package visibility" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_8_publish_and_install.png" alt="Transport targets" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_9_publish_and_install.png" alt="SAP Package name" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_10_publish_and_install.png" alt="Optional steps" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_11_publish_and_install.png" alt="Package published" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_12_publish_and_install.png" alt="Package viewed in registry" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_13_publish_and_install.png" alt="List installed packages" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_14_publish_and_install.png" alt="Install command" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_15_publish_and_install.png" alt="Install success" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/assets/examples/1_16_publish_and_install.png" alt="List and view commands" style="max-width:100%; height:auto; border-radius:8px;">
</div>

We can now take it to the next step: let’s see how TRM handles dependencies!

➡️ Next: [Package with dependencies](2_package_with_dependencies.md)
