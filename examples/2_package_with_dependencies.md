...
<div style="display:flex; gap:12px; flex-wrap:wrap">
  <img src="/examples/media/2_1_package_with_dependencies.png" alt="Creating a package" style="flex:1 1 300px; max-width:100%; height:auto">
  <img src="/examples/media/2_2_package_with_dependencies.png" alt="Creating a class" style="flex:1 1 300px; max-width:100%; height:auto">
</div>

Just like last time, let’s check what’s currently in my workspace:

<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_3_package_with_dependencies.png" alt="Current workspace viewed in Eclipse" style="max-width:100%; height:auto; border-radius:8px;">
</div>

And here’s the implemented utility class:

<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_4_package_with_dependencies.png" alt="Utility class implemented" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_5_package_with_dependencies.png" alt="Utility class usage" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_6_package_with_dependencies.png" alt="Failed publish" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_7_package_with_dependencies.png" alt="Utility publish" style="max-width:100%; height:auto; border-radius:8px;">
</div>

With `@trmsamples/doc-utility` published, let’s retry publishing `@trmsamples/doc-demo`.

<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_8_package_with_dependencies.png" alt="Successful publish" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_9_package_with_dependencies.png" alt="Release on registry" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_10_package_with_dependencies.png" alt="Confirm install dependency" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_11_package_with_dependencies.png" alt="Install of dependency and package" style="max-width:100%; height:auto; border-radius:8px;">
</div>

After confirming, the installation of **both packages** continues normally.

<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_12_package_with_dependencies.png" alt="List command" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_13_package_with_dependencies.png" alt="Code using SPELL_AMOUNT" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_14_package_with_dependencies.png" alt="Publish with SAP entries" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_15_package_with_dependencies.png" alt="sap_entries.json file" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_16_package_with_dependencies.png" alt="Find dependencies command" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_17_package_with_dependencies.png" alt="Install with SAP entries silently checked" style="max-width:100%; height:auto; border-radius:8px;">
</div>

SAP entries are **checked silently**, and then we’re prompted to install the TRM dependencies of the package.

<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_18_package_with_dependencies.png" alt="Deleting the required function module" style="max-width:100%; height:auto; border-radius:8px;">
</div>
...
<div style="display:flex; justify-content:center;">
  <img src="/examples/media/2_19_package_with_dependencies.png" alt="Install with missing SAP entries" style="max-width:100%; height:auto; border-radius:8px;">
</div>
